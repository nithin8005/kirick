...
export default function SocialMediaSection({ comicTitle = false, sectionId, comicBox = false }) {
  return (
    <section
      id={sectionId}
      className={`social-wire section section--warm${comicBox ? ' social-wire--comic-box' : ''}`}
    >
